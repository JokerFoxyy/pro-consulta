        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Documento = table.Column<string>(type: "NVARCHAR(50)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nome = table.Column<string>(type: "VARCHAR(50)", nullable: false),
                    Documento = table.Column<string>(type: "NVARCHAR(50)", nullable: false),
                    Crm = table.Column<string>(type: "NVARCHAR(50)", nullable: false),
                    DataCadastro = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Celular = table.Column<string>(type: "NVARCHAR(50)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Agendamentos_Pacientes_PacientId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "95433ac4-2fe9-468f-b80d-b05ec3724d1d", 0, "2d1846cd-24a5-499c-b09a-2c8dcfaafe35", "Atendente", "proconsulta@hotmail.com.br", true, false, null, "Pro Consulta", "PROCONSULTA@HOTMAIL.COM.BR", "PROCONSULTA@HOTMAIL.COM.BR", "AQAAAAIAAYagAAAAEE1ArrCeuGZ7KTEFHBYlciW1WBGrhnbCCc2QAt9Xx2o/y2ENIKN6HTZCjEL5L/knxA==", null, false, "303bd568-226c-4006-ace0-d455cbc2a913", false, "proconsulta@hotmail.com.br" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Especialidade que cuida de doenças do coração", "Cardiologia" },
                    { 2, "Especialidade que cuida de doenças do cerebro", "Neurologia" },
                    { 3, "Especialidade que cuida de doenças do rim", "Nefrologia" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Agendamentos_PacientId",
                table: "Agendamentos",
                column: "PacientId");
